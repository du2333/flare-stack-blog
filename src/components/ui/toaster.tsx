    ...
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          closeButton:
            "!absolute !right-2 !top-2 !left-auto !bottom-auto !transform-none !bg-background !border !border-border/60 !text-muted-foreground/60 hover:!text-foreground hover:!bg-muted !transition-all !p-1 !rounded-sm shadow-sm",
        },
      }}
      {...props}
    />
