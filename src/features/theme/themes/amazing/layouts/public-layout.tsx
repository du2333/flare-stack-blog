...
export function PublicLayout({
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (bannerRef.current) {
        ...
        bannerRef.current.style.transform = `translateY(${scrollY * 0.35}px) scale(1.1)`;
      }
    };
  ...
  return (
    <div className="relative min-h-screen bg-(--fuwari-page-bg) transition-colors">
      ...
      {/* Banner - full width background with parallax */}
      <div
      ...
      >
        <div ref={bannerRef} className="w-full h-full will-change-transform">
          <img
        ...
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-(--fuwari-page-bg) to-transparent pointer-events-none" />
      </div>
