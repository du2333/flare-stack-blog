...
/**
 * Enhanced Posts Page — Amazing Theme
 *
 * Features:
 * - Archive panel with staggered fade-up entrance
 * - Improved infinite scroll skeleton with pulse
 * - End-of-content indicator with gradient lines
 */
    ...
    >
      ...
      >
        {isFetchingNextPage ? (
          ...
          <div className="h-px w-24 bg-gradient-to-r from-transparent via-black/15 dark:via-white/15 to-transparent" />
        ) : posts.length > 0 ? (
