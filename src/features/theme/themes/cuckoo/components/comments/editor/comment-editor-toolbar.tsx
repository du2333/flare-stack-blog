...
const ToolbarButton: React.FC<ToolbarButtonProps> = ({
  ...
  <button
    ...
    className={cn(
      ...
      isActive
        ? "bg-(--cuckoo-primary) text-white dark:text-black/75"
        : "cuckoo-text-50 hover:bg-black/5 dark:hover:bg-white/10 hover:cuckoo-text-75",
    )}
    title={label}
    type="button"
  >
...
const CuckooCommentEditorToolbar: React.FC<CommentEditorToolbarProps> = ({
  editor,
  onLinkClick,
  onImageClick,
}) => {
...
export default CuckooCommentEditorToolbar;
